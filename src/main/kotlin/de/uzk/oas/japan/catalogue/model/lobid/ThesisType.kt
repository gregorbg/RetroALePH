...
interface ThesisData {
    val thesisInformation: List<String>
}

sealed class ThesisType : BookType(), ThesisData {
    @Serializable
...
data class Thesis(
    ...
    override val thesisInformation: List<String> = emptyList(),
    @SerialName("@context") val context: String,
    val issn: List<String> = emptyList(), // FIXME GB wrong data! report to GitHub!
) : BookType(), ThesisData