...
interface PeriodicalData : SeriesData

sealed class PeriodicalType : BibliographicResource(), PeriodicalData {
    @Serializable
    data class Proceedings(
        ...
        val isbn: List<String> = emptyList(), // FIXME GB wrong! report on GitHub!
    ) : PeriodicalType()
    ...
    data class Bibliography(
        ...
        override val titleOfSubSeries: String? = null,
        @SerialName("@context") val context: String
    ) : PeriodicalType(), BibliographyData
}
