...
interface SeriesData {
    ...
    val zdbId: String?
    val titleOfSubSeries: String?
}

sealed class SeriesType : BibliographicResource(), SeriesData {
    @Serializable
    data class Thesis(
...
) : BibliographicResource(), SeriesData