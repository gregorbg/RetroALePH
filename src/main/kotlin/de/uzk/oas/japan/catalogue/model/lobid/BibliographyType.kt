...
sealed class BibliographyType : BookType(), BibliographyData {
    sealed class BiographyType : BibliographyType(), BiographyData {
        @Serializable
    ...
    data class Biography(
        ...
        override val spatial: List<Spatial> = emptyList(),
        @SerialName("@context") val context: String,
    ) : BibliographyType(), BiographyData
