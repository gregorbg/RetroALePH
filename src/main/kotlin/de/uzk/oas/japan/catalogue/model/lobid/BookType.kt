...
sealed class BookType : BibliographicResource(), BookData {
    @Serializable
    data class OfficialPublication(
...
data class Book(
    ...
    override val spatial: List<Spatial> = emptyList(),
    @SerialName("@context") val context: String,
    val issn: List<String> = emptyList(), // FIXME GB wrong! report GitHub issue! not in MAB2 MARC!
    val dateOfBirth: String? = null, // FIXME GB wrong! report GitHub issue!
) : BibliographicResource(), BookData
