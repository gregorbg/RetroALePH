...
interface FestschriftData

sealed class FestschriftType : BookType(), FestschriftData {
    @Serializable
    ...
    data class PublishedScore(
        ...
        @SerialName("@context") val context: String
    ) : FestschriftType(), PublishedScoreData
    ...
    data class Bibliography(
        ...
        override val spatial: List<Spatial> = emptyList(),
        @SerialName("@context") val context: String
    ) : FestschriftType(), BibliographyData
}
